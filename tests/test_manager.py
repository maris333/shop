...
class TestManager:
    ...
    def test_check_if_too_little_is_in_stock(self, manager: Manager, oranges_order: Order):
    ...
    def test_add_existing_order_check_if_stock_is_reduced(self, manager: Manager, oranges_order: Order):
        manager.add_order(oranges_order, 10)
    ...
    def test_add_existing_order_check_if_not_enough_in_stock(self, manager: Manager, oranges_order: Order):
    ...
    def test_delete_existing_order_check_if_stock_is_refilled(self, manager: Manager, oranges_order: Order):
        manager.add_order(oranges_order, 10)
